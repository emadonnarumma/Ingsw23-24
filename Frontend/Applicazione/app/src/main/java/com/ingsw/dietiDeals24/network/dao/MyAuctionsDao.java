...
public interface MyAuctionsDao {
    ...
    Call<List<SilentAuction>> getSilentAuctions(@Path("email") String email, @Header("Authorization") String authToken);

    @GET("auction/{email}/getDownwardAuctions")
    Call<List<DownwardAuction>> getDownwardAuctions(@Path("email") String email, @Header("Authorization") String authToken);

    @GET("auction/{email}/getReverseAuctions")
    Call<List<ReverseAuction>> getReverseAuctions(@Path("email") String email, @Header("Authorization") String authToken);
