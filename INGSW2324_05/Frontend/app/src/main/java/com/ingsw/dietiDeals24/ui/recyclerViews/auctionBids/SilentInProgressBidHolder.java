...
public class SilentInProgressBidHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(SilentBid silentBid) {
        ...
        acceptButton.setOnClickListener(v -> PopupGenerator.areYouSureToAcceptBidPopup(activity, silentBid));
        declineButton.setOnClickListener(v -> PopupGenerator.areYouSureToDeclineBidPopup(activity, silentBid));
    }
}
